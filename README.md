...
- que pasa 4x cada luna
- su maletero granja
- sembrando a todås vecinås
- un trueque con o sin precio
- sea: plantas, rastro, productos locales
- con gente real dentro
- sea o no del ayuntamiento
- ayuda a la cosecha
- o arregla tu estanqueria
- de fincas a laderas
- charla al compartir noticias
- intercambia frutas, flores, libros
- verdura fresca y taros sorpresa
